...
const SelectFeild = ({options,setValCallback}) => {
    ...
    return (
        <div className={`my-3`}>
            <select id="countries" defaultValue={'null'} onChange={handleSelectedValue} className="bg-gray-50 capitalize border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
